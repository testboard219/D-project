		...
		<div class="login-page">
			<div class="main-login-contain">
				...
				<div class="login-form">
					<form method="POST" action="https://ness-lite.com/passwordrecovery">
					<input type="hidden" name="csrf_token" value="de95165c517b87a26d3e3de0cfddf381">
						<div class="login_input">
							
						</div>
						<p style="color:red" class="btn btn-primary btn-login">please enter a valid emaill address</p>
						
						<div class="goto-login">
							<div class="sign-up-login">
								<i class="arrow_back" href="signup.php"></i>
								
								<button class="btn btn-primary"><a href="signup.php">go back</a></button>
							</div>
						</div>
					</form>
				</div>
